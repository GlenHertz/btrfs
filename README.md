...
In /etc/fstab:
```
LABEL=btrfs_pool      /                btrfs   defaults,noatime,subvol=root           0 0
LABEL=btrfs_pool      /home            btrfs   defaults,noatime,subvol=home           0 0
...
LABEL=btrfs_pool      /media/btrfs     btrfs   defaults,noauto,subvolid=0             0 0
